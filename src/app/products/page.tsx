...
import NewsletterInsta from "../components/newsletterinsta"

const Products = () => {
    return(
        <div className="w-[1920px] h-auto absolute top-[260px] flex flex-col">
            <h1 className="h-[44px] pr-[300px] pl-[300px] font-Inter text-[32px] font-semibold leading-[35.2px] text-[#272343]">All Products</h1>
